...
while True:
    ...
    if r:
        ...
        gray_frame = cv2.cvtColor(img, cv2.COLOR_RGB2GRAY) # HOG needs a grayscale image
        ...
        for i, (x, y, w, h) in enumerate(rects):
            if weights[i] < 0.7:
                continue
            # Draw a rectangle around the pedestrian
...
with open('hog_results.csv', 'w') as f:
